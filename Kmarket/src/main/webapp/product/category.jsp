...
<meta charset="UTF-8">
    <aside>
        <ul class="category">
            ...
            <li>
                <a href="/Kmarket/product/list.do?prodCate1=15"><i class="fas fa-laptop" aria-hidden="true"></i>가전·디지털</a>
                <ol>
            ...
            <li>
                <a href="/Kmarket/product/list.do?prodCate1=13"><i class="fas fa-utensils" aria-hidden="true"></i>식품·생필품</a>
                <ol>
            ...
            <li>
                <a href="/Kmarket/product/list.do?prodCate1=14"><i class="fas fa-home" aria-hidden="true"></i>홈·문구·취미</a>
                <ol>
