...
<script src="/Kmarket/admin/product/js/cateValue.js"></script>
            ...
            <section id="admin-product-register">
                ...
                <article>
                        <!-- 상품분류 -->
		                <form action="/Kmarket/admin/product/modify.do" name="cateForm"method="post" enctype="multipart/form-data">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <input type="text" name="descript" value="${produdct.descript}">
                                    </td>
                                    </tr>
                                    <tr>
                                        <td>제조사</td>
